...
const steps = [
    {
      ...
      description: "Glide backward into position"
    },
    {
      title: "Step 02: Entry:",
      description: "Land on the left foot with the right foot on an inside edge behind it."
    },
    {
      title: "Step 03: Jump",
      description: "Push off the right toe pick, pivoting on the left foot."
    },
    {
    title: "Step 04: Rotation",
    description: "Swing arms counterclockwise to aid the turn."
    },
    {
        title: "Step 05: Landing",
        description: "Land on the right foot, bend the knee, and extend the left (free) leg out."
      },
  ];
