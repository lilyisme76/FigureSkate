...
const steps = [
    {
      ...
      description: "Glide backward on both feet with your left arm in front and right arm behind."
    },
    {
      title: "Step 02: Takeoff",
      description: "pin on the right foot, kick the left foot, and swing arms counterclockwise to launch."
    },
    {
      title: "Step 03: Rotation",
      description: "Complete a full rotation with arms spread."
    },
    {
        title: "Step 04: Landing",
        description: "Land on the right foot, bend the right knee, and extend the left (free) leg out to the side."
      },
  ];
